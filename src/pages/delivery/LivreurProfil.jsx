...
import { User, Save, Lock, AlertCircle, CheckCircle2, Settings, Shield, Palette, Truck, Bell, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="w-full flex flex-col gap-8 max-w-[1400px] mx-auto pb-10">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">Gérez la configuration de votre espace livreur</p>
                </div>
            </div>
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                                    isActive 
                                        ? 'bg-[#6d28d9] text-[#0F1117] shadow-lg shadow-[#6d28d9]/20 font-bold' 
                    ...
                    {activeTab === 'profil' && (
                        <div className="flex flex-col">
                            <div className="px-8 py-6 border-b border-white/5 flex items-center gap-3">
                                ...
                                <h2 className="text-lg font-bold text-white">Profil Livreur</h2>
                            </div>
                            ...
                            <form onSubmit={saveProfile} className="p-8 flex flex-col gap-8">
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="relative">
                                        {/* Fake border to match design, since AvatarUpload handles image */}
                                        <div className="absolute -inset-1 border-2 border-[#C9A84C] rounded-full pointer-events-none z-10 opacity-50"></div>
                                        <AvatarUpload user={user} setUser={setUser} size="w-24 h-24" textSize="text-3xl" />
                                    </div>
                                    <div className="flex flex-col">
                                        <h3 className="text-base font-bold text-white">Avatar du profil</h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Nom complet</label>
                                        <input 
                                            type="text" 
                                            name="name"
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Adresse Email</label>
                                        <input 
                                            type="email" 
                                            name="email"
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Téléphone</label>
                                        <input 
                                            type="text" 
                                            name="phone"
                                ...
                                <div className="flex justify-end mt-4 pt-6 border-t border-white/5">
                                    <button 
                                        type="submit" 
                                        disabled={isSaving}
                                        className="bg-[#6d28d9] hover:bg-[#5b21b6] text-[#0F1117] font-bold px-6 py-2.5 rounded-xl transition-all disabled:opacity-50 flex items-center gap-2 shadow-lg shadow-[#6d28d9]/20"
                                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <form onSubmit={savePassword} className="p-8 flex flex-col gap-6">
                                <div className="flex flex-col gap-2 max-w-md">
                                    <label className="text-xs font-bold text-gray-300">Mot de passe actuel</label>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Nouveau mot de passe</label>
                                        <div className="relative group">
                                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within:text-[#a78bfa] transition-colors" />
                                            <input 
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Confirmer mot de passe</label>
                                        <div className="relative group">
                                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within:text-[#a78bfa] transition-colors" />
                                            <input 
                            ...
                            <div className="p-8 flex flex-col gap-8">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <button 
                                            ...
                                            className={`flex flex-col items-center justify-center gap-3 p-6 rounded-xl border transition-all ${
                                                theme === 'dark' ? 'border-[#C9A84C] bg-[#6d28d9]/10' : 'border-white/5 bg-transparent hover:bg-white/5'
                                            }`}
                                        >
                                        ...
                                        <button 
                                            ...
                                            className={`flex flex-col items-center justify-center gap-3 p-6 rounded-xl border transition-all ${
                                                theme === 'light' ? 'border-[#C9A84C] bg-[#6d28d9]/10' : 'border-white/5 bg-transparent hover:bg-white/5'
                                            }`}
                                        >
                                ...
                                <div className="flex justify-start mt-4">
                                    <button 
                                        ...
                                        className="text-[#0F1117] font-bold px-6 py-2.5 rounded-xl transition-all flex items-center gap-2 shadow-lg hover:opacity-90"
                    ...
                    {activeTab === 'vehicule' && (
                        <div className="flex flex-col">
                            <div className="px-8 py-6 border-b border-white/5 flex items-center gap-3">
                                ...
                                <h2 className="text-lg font-bold text-white">Informations du Véhicule</h2>
                            </div>
                            
                            <form className="p-8 flex flex-col gap-8">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Type de véhicule</label>
                                        <input 
                                            type="text" 
                                            defaultValue="Moto"
                                            className="w-full bg-[#0F1117] border border-white/5 focus:border-[#6d28d9]/50 rounded-xl px-4 py-3 text-sm text-white outline-none transition-all"
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-300">Plaque d'immatriculation</label>
                                        <input 
                                            type="text" 
                                            defaultValue="12345-A-1"
                                            className="w-full bg-[#0F1117] border border-white/5 focus:border-[#6d28d9]/50 rounded-xl px-4 py-3 text-sm text-white outline-none transition-all"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end mt-4">
                                    <button 
                                        type="button"
                                        className="bg-[#6d28d9] hover:bg-[#5b21b6] text-[#0F1117] font-bold px-6 py-2.5 rounded-xl transition-all flex items-center gap-2 shadow-lg shadow-[#6d28d9]/20"
                                    >
                                        <Save className="w-4 h-4" /> Sauvegarder
                                    </button>
                                </div>
                            ...
                            <form className="p-8 flex flex-col gap-8">
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h4 className="text-sm font-bold text-white">Nouvelle livraison assignée</h4>
                                            <p className="text-xs text-gray-400 mt-1">Alerte lors d'une nouvelle assignation de commande</p>
                                        </div>
                                        <button 
                                            type="button" 
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 mt-1">Alerte si une commande assignée est modifiée ou annulée</p>
                                        </div>
                                        <button 
                                            type="button" 
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h4 className="text-sm font-bold text-white">Rappels de livraison</h4>
                                            <p className="text-xs text-gray-400 mt-1">Alerte pour les livraisons qui risquent d'être en retard</p>
                                        </div>
                                        <button 
                                            type="button" 
                                            onClick={() => setNotifications({...notifications, deliveryReminder: !notifications.deliveryReminder})}
                                            className={`w-11 h-6 rounded-full transition-colors relative ${notifications.deliveryReminder ? 'bg-[#6d28d9]' : 'bg-white/10'}`}
                                        >
                                            <div className={`w-4 h-4 rounded-full bg-white absolute top-1 transition-transform ${notifications.deliveryReminder ? 'translate-x-6' : 'translate-x-1'}`} />
                                        </button>
                                    </div>
                                </div>
